...
type KeyLimits struct {
	...
	EventsPerSecond    int `json:"events_per_second"`    // max number of events per second
	SubscribersPerNode int `json:"subscribers_per_node"` // max number of subscribers per node
