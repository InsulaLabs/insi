...
.PHONY: all clean server client fwit objects test prod server-prod client-prod fwit-prod objects-prod cross

all: server client fwit objects
...
objects: ${BUILD_DIR}
	@echo "$(BLUE)🚀 Building objects tool $(BINARY_OBJECTS)...$(RESET)"
	@echo "$(PURPLE)   Compiling Go code for $(BINARY_OBJECTS)...$(RESET)"
	@$(GOPRIVATE_SETTING) go build -o ${BUILD_DIR}/${BINARY_OBJECTS} cmd/objects/*.go
	@echo "$(GREEN)✅ Objects tool $(BINARY_OBJECTS) build complete! Available at ${BUILD_DIR}/${BINARY_OBJECTS}$(RESET)"
...
prod: server-prod client-prod fwit-prod objects-prod
...
objects-prod: ${BUILD_DIR}
	@echo "$(BLUE)🚀 Building PRODUCTION objects tool $(BINARY_OBJECTS)...$(RESET)"
	@echo "$(PURPLE)   Compiling Go code for $(BINARY_OBJECTS) (production)...$(RESET)"
	@$(GOPRIVATE_SETTING) go build $(LDFLAGS_PROD) -o ${BUILD_DIR}/${BINARY_OBJECTS} cmd/objects/*.go
	@echo "$(GREEN)✅ PRODUCTION Objects tool $(BINARY_OBJECTS) build complete! Available at ${BUILD_DIR}/${BINARY_OBJECTS}$(RESET)"
...
cross: ${BUILD_DIR}
	...
	@$(GOPRIVATE_SETTING) GOOS=darwin GOARCH=amd64 go build -o ${BUILD_DIR}/${BINARY_FWIT}-darwin-amd64 cmd/fwit-t/*.go
	@$(GOPRIVATE_SETTING) GOOS=darwin GOARCH=amd64 go build -o ${BUILD_DIR}/${BINARY_OBJECTS}-darwin-amd64 cmd/objects/*.go
	...
	@$(GOPRIVATE_SETTING) GOOS=darwin GOARCH=arm64 go build -o ${BUILD_DIR}/${BINARY_FWIT}-darwin-arm64 cmd/fwit-t/*.go
	@$(GOPRIVATE_SETTING) GOOS=darwin GOARCH=arm64 go build -o ${BUILD_DIR}/${BINARY_OBJECTS}-darwin-arm64 cmd/objects/*.go
	...
	@$(GOPRIVATE_SETTING) GOOS=windows GOARCH=amd64 go build -o ${BUILD_DIR}/${BINARY_FWIT}-windows-amd64.exe cmd/fwit-t/*.go
	@$(GOPRIVATE_SETTING) GOOS=windows GOARCH=amd64 go build -o ${BUILD_DIR}/${BINARY_OBJECTS}-windows-amd64.exe cmd/objects/*.go
	...
	@$(GOPRIVATE_SETTING) GOOS=windows GOARCH=arm64 go build -o ${BUILD_DIR}/${BINARY_FWIT}-windows-arm64.exe cmd/fwit-t/*.go
	@$(GOPRIVATE_SETTING) GOOS=windows GOARCH=arm64 go build -o ${BUILD_DIR}/${BINARY_OBJECTS}-windows-arm64.exe cmd/objects/*.go
	...
	@$(GOPRIVATE_SETTING) GOOS=linux GOARCH=amd64 go build -o ${BUILD_DIR}/${BINARY_FWIT}-linux-amd64 cmd/fwit-t/*.go
	@$(GOPRIVATE_SETTING) GOOS=linux GOARCH=amd64 go build -o ${BUILD_DIR}/${BINARY_OBJECTS}-linux-amd64 cmd/objects/*.go
	...
	@$(GOPRIVATE_SETTING) GOOS=linux GOARCH=arm64 go build -o ${BUILD_DIR}/${BINARY_FWIT}-linux-arm64 cmd/fwit-t/*.go
	@$(GOPRIVATE_SETTING) GOOS=linux GOARCH=arm64 go build -o ${BUILD_DIR}/${BINARY_OBJECTS}-linux-arm64 cmd/objects/*.go
