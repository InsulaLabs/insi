...
var _ runtime.Service = &IslandPlugin{}
...
func (p *IslandPlugin) Init(prif runtime.ServiceRuntimeIF) *runtime.ServiceImplError {
	p.prif = prif
...
func (p *IslandPlugin) GetRoutes() []runtime.ServiceRoute {
